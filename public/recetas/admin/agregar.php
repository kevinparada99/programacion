...
<div class="container">
    ...
    <textarea type="text"  name="nombre" class="form-control" style="width: 900px; height: 80px;font-size: 20px;"  placeholder="Texto a mostrar"></textarea>
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1" style="font-size: 20px;">Proceso</label>
    <textarea type="text" style="width: 900px; height: 200px; font-size: 12px;" name="informacion" class="form-control"  placeholder="Tema"></textarea>
  </div>
