...
class PDF extends FPDF{    
    function Header() {   
       ...
       $consulta = "SELEcT * FROM cart Where user_id = $idUsuario  AND product_cat = 1 AND peso = 2";
    ...
    $consultaM = "SELEcT * FROM cart Where user_id =$idUsuario AND product_cat = 2 AND peso = 2";
    ...
    $consultaA = "SELEcT * FROM cart Where user_id = $idUsuario AND product_cat = 3 AND peso = 2";
    ...
    while($rowA = $resultadoA->fetch_assoc()){
     ...
     $consultaME = "SELEcT * FROM cart Where user_id = $idUsuario AND product_cat = 4 AND peso = 2";
    ...
    while($rowME = $resultadoME->fetch_assoc()){
     ...
     $consultaCE = "SELEcT * FROM cart Where user_id = $idUsuario AND product_cat = 5 AND peso = 2";
