...
if($link){
  ...
  $NameUser = $_POST['NameUser'];
    if($idUser == $idEnvia){
      ...
      $resultado=$link->query("SELECT EXISTS (SELECT * FROM compartir WHERE user_id ='$idEnvia' AND peso = '1');");
      ...
      if ($row[0]=="1") {                 
        ...
        select p_id,product_title,'$idEnvia',product_image,price,total_amount,'$NameUser',product_cat,'$idUser','1' from cart where user_id = '$idEnvia'";
