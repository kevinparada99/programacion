...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-04-2020 a las 18:49:24
...
(13, 13, 'fiebre', '2020-04-11'),
(14, 13, 'azucar', '2020-04-04');
...
INSERT INTO `productos` (`codigo`, `nombre`, `cantidad`, `tipo`, `fecha`, `idProducto`) VALUES
('usia0021', 'carne', '25', '', '0000-00-00', 4),
('f14', 'agua', '14', 'comida', '2020-04-16', 6),
('f52', 'asetaminofen', '255', 'medicamentos', '2020-04-09', 7);
...
INSERT INTO `usuarios` (`codigo`, `nombre`, `edad`, `inicial`, `fechaini`, `actual`, `fechaac`, `medicamento`, `observacion`, `idUsuario`) VALUES
('usi00', 'fransisco', '50', '100', '0000-00-00', '', '0000-00-00', '', 'ninguna', 13),
('usi89', 'kevin', '15', '50', '2020-04-09', '', '0000-00-00', '', 'ninguna', 14),
('usd', 'francisco', '85', '25', '2020-04-09', '14', '2020-04-18', '', 'ninguna', 15),
('usus', 'jeny', '2020-', '25lb', '2020-04-01', 'jj', '2020-04-22', '', 'hh', 16),
('14', 'rosa', '2020-', '25', '2020-04-03', 'f', '2020-04-23', 'si', 'no', 17);
...
--
ALTER TABLE `controles`
  MODIFY `idControl` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
